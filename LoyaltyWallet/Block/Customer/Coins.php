...
class Coins extends Template
{
    ...
    public function getTotalCoins(): int
    {
        ...
        $this->logger->info('getTotalCoins Called', ['transaction_count' => count($transactions)]);
        ...
        $this->logger->info('Transactions Sorted by Entity ID (Ascending)', ['sorted_entity_ids' => $sortedIds]);
        ...
        $this->logger->info('Latest Transaction Balance Resolved', ['latest_entity_id' => $latestTransaction ? $latestTransaction->getEntityId() : null, 'balance_after' => $balanceAfter, 'final_returned_balance' => $finalBalance]);
